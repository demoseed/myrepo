...
/**
 * SS User Import Export config.php
 *
 * This file exists only as a template for the SS User Import Export settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'ss-user-import-export.php'
